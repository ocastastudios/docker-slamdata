...
ENV QUASAR_VERSION="13.0.27"
ENV SLAM_VERSION="4.0.5"
ADD run.sh /run.sh
...
RUN wget -O quasar.jar -q https://github.com/quasar-analytics/quasar/releases/download/v${QUASAR_VERSION}-quasar-web/quasar-web-assembly-${QUASAR_VERSION}.jar && \
